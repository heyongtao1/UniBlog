    ...
    CBaseDialog(parent)
{
    ...
    labelIcon->setPixmap(QPixmap(":/resources/image/comimage/ic_info.png"));
...
void CMessageBox::ShowMessage(const QString &content, const quint8 &msgType, const QString &title)
{
    ...
    if (CMessageBox::Information == msgType)
        ...
        labelIcon->setPixmap(QPixmap(":/resources/image/comimage/ic_warning.png"));
    else if (CMessageBox::Questions == msgType)
        labelIcon->setPixmap(QPixmap(":/resources/image/comimage/对勾小.png"));
    else
        labelIcon->setPixmap(QPixmap(":/resources/image/comimage/ic_info.png"));
}
