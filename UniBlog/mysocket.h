...
signals:
    ...
    void pubBlogEditMagSignal(bool state);
    void userAllBlogEditMagSignal(QJsonValue dataVal);
    void findBlogEditMagSignal(QJsonValue dataval);
    void recomBlogEditMsgSignal(QJsonValue datval);
