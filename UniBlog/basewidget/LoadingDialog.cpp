...
{
    timer = new QTimer();
    connect(timer,&QTimer::timeout,this,&LoadingDialog::stoploadingDialog);
...
void LoadingDialog::initUi()
{
    ...
    //加载Loading动画
    m_pLoadingMovie = new QMovie(":/resources/image/login/loading.gif");
...
void LoadingDialog::stoploadingDialog()
{
